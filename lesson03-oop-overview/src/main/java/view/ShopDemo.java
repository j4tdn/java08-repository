...
public class ShopDemo {
	...
	public static final LocalDate DISCOUNT_DATE = LocalDate.of(2020, 05, 05);
	public static final double DISCOUNT_PRICE = 590;
	public static final double SALES_RATE_PRICE = 0.9;
	...
	public static void main(String[] args) {
		...
		Bill thirdBill = new Bill("b03", john, thirdItems, LocalDate.of(2020, Month.MAY, 02));
