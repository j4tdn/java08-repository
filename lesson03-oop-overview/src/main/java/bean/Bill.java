...
public class Bill {
	...
	public double getTotalOfMoney() {
		...
		Item[] items = this.getItems();  //this la doi tuowng hien dang goi den, co kieu du lieu la Bill; static doi tuong se duoc khoi tao cung luc khi load chuong trinh (khoi tao truoc khi tao doi tuong)
