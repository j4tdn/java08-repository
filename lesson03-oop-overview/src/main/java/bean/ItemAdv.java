...
public class ItemAdv {
	...
	// private: de ben ngoai ko tao constructor duoc, ko biet cac doi tuong duoc tao
	// ntn
	...
	public static class Builder { // dung thang nay de tao roi copy vao ItemAdv
		...
		// tao 1 doi tuong ItemAdv cho doi tuong hien tai
		public ItemAdv build() {
			return new ItemAdv(this); //Builder builder
