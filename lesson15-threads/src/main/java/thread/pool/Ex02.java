...
public class Ex02 {
	...
	private static final String[] stuffs= {"latop","pen","box","key"};
	...
	public static void main(String[] args) throws InterruptedException, ExecutionException {
		...
		for(Future<String> future:futures) {
			System.out.println("future: "+future.get());//future cho tra ve sau khi task thuc thi
		}
	...
	private static class Task implements Callable<String>{//call là task tt tra ve value
