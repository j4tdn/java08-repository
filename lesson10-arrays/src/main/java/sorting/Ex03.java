...
public class Ex03 {
	...
	public static void main(String[] args) {
		Item[] items = getItems();
		// sort(items);
		//Arrays.sort(items, comparing(Item::getName).thenComparing(Item::getId));
		// Arrays.sort(items, comparing(Item::getId));
		
		/*
		 * Arrays.sort(items, new Comparator<Item>() {
		 * 
		 * @Override public int compare(Item o1, Item o2) { int id1 = o1.getId(); int
		 * id2 = o2.getId(); if (id1 == id2) { return
		 * o1.getName().compareTo(o2.getName()); } return id1 - id2; } });
		 */
