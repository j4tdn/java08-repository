 ...
 */
public class StringBufferWithMulThreadDemo implements Runnable {

    StringBuffer stringMutable;

    public StringBufferWithMulThreadDemo() {
    ...
    public static void main(String[] args) {
    	...
    	StringBufferWithMulThreadDemo strBldrWthThrdDmobj1 = new StringBufferWithMulThreadDemo();
