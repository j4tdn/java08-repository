...
public class Demo {
	public static void main(String[] args) {
		Employee emp1 = new Employee(1, "a@gmail.com", "e1", "e1");
		Employee emp2 = new Employee(2, "a@gmail.com", "e2", "e2");
		Employee emp3 = new Employee(3, "a@gmail.com", "e3", "e3");
		
		Project pro1 = new Project(1, "P1", 100);
		Project pro2 = new Project(2, "P2", 100);
