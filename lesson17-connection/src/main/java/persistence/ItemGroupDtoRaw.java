...
public class ItemGroupDtoRaw {
		...
		public void setItemName(String itemList) {
		...
		public boolean equals(Object o) {
			...
			if (!(o instanceof ItemGroupDtoRaw)) {
				return false;
			}
		...
		public String toString() {
			return "ItemGroupDto [itemGroupId=" + itemGroupId + ", itemGroupName=" + itemGroupName + ", itemName="
