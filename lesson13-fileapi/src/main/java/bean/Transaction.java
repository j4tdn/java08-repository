...
public class Transaction {
	...
	public Transaction(String stringLine) {
		...
		if (elements.length == 4) {
			...
			String name = traderAttributes.substring(1, traderAttributes.indexOf(","));
			String city = traderAttributes.substring(traderAttributes.indexOf(",") + 1);
	...
	public String toString() {
		return id + " - " + trader.getName() + "," + trader.getCity() + " - " + year + " - " + value;
	}
